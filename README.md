...
Для реализации работы использовата звезда-схема (см [./init](init)), созданная в [Лабораторной работе №1](https://github.com/Nadezhda13Soloveva/BigData_HW_1). Также реализован [ETL-пайплайн](code) с помощью Apache Spark и в итоге сформировано 6 витрин (отчётов) в ClickHouse и дополнительно в MongoBD.
